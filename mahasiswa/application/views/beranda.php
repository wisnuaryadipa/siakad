			  ...
			  <div class="row">
				<div class="col-sm-4 col-md-2">
				  ...
				  <div class="color-palette-set">
					<a href="<?php echo site_url('users') ?>"><center><i class="fa fa-user" style="font-size:48px;color:#3c8dbc"></i><center></a>					
				  </div>
				</div>
				<div class="col-sm-4 col-md-2">
				  ...
				  <div class="color-palette-set">
					<a href="<?php echo site_url('matakuliah') ?>"><center><i class="fa fa-bookmark-o" style="font-size:48px;color:#3c8dbc"></i><center></a>					
				  </div>
				</div>
				<div class="col-sm-4 col-md-2">
				  ...
				  <div class="color-palette-set">
					<a href="<?php echo site_url('mahasiswa') ?>"><center><i class="fa fa-users" style="font-size:48px;color:#3c8dbc"></i><center></a>					
				  </div>
				</div>				
				<!-- /.col -->
				<div class="col-sm-4 col-md-2">
