<?php
/*******************************************************************/
/* File        : Tentang_kampus.php                             */
/* Lokasi File : ./application/controllers/Tentang_kampus.php   */
...
class Tentang_kampus extends CI_Controller
{
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            $data = array(
		'id_tentangkampus' => $row->id_tentangkampus,
		'judul_tentangkampus' => $row->judul_tentangkampus,
		'isi_tentangkampus' => $row->isi_tentangkampus,
		'keterangan_tambahan' => $row->keterangan_tambahan,
		'gambar' => $row->gambar,
		'aktif' => $row->aktif,
	    );
            $this->load->view('tentang_kampus/tentang_kampus_read', $data);
        } else {
...
/* End of file Tentang_kampus.php */