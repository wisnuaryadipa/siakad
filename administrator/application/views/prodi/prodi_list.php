        ...
        <div class="box-body">
			...
			<div class="row" style="margin-bottom: 10px">
				...
				<div class="col-md-4 text-right">
					<?php echo anchor(site_url('prodi/create'), '<i class="fa fa-file-text" aria-hidden="true"></i>&nbsp;Create', 'class="btn btn-primary"'); ?>
			</div>
			</div>
						...
						columns: [
							{
								"data": "id_prodi",
								"orderable": false
							},{"data": "kode_prodi"},{"data": "nama_prodi"},{"data": "nama_jurusan"},
							{
								"data" : "action",
								"orderable": false,
