        ...
        <ul class="nav navbar-nav">          
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('s-160x160.jpg') ?>" class="user-image" alt="User Image">
			...
			<div class="box-body">
			  <div class="row">
				...
				<div class="col-sm-4 col-md-2">
				  ...
				  <div class="color-palette-set">
					<a href="<?php echo site_url('inputNilai') ?>"><center><i class="fa fa-sort-numeric-asc" style="font-size:48px;color:#3c8dbc"></i><center></a>	
				  </div>
				</div>
				<!-- /.col -->
				<div class="col-sm-4 col-md-2">
				  ...
				  <div class="color-palette-set">
					<a href="<?php echo site_url('buatTranskrip') ?>"><center><i class="fa fa-print" style="font-size:48px;color:#3c8dbc"></i><center></a>	
				  </div>
				</div>
				<!-- /.col -->
			  </div>
			  ...
			  <div class="row">
				...
				<div class="col-sm-4 col-md-2">
				  ...
				  <div class="color-palette-set">
					<a href="<?php echo site_url('informasi') ?>"><center><i class="fa fa-globe" style="font-size:48px;color:#3c8dbc"></i><center></a>
				  </div>
				</div>
				<!-- /.col -->
				<div class="col-sm-4 col-md-2">
				  ...
				  <div class="color-palette-set">
					<a href="<?php echo site_url('identitas') ?>"><center><i class="fa fa-vcard-o" style="font-size:48px;color:#3c8dbc"></i><center></a>
				  </div>
				</div>
				<!-- /.col -->
				<div class="col-sm-4 col-md-2">
